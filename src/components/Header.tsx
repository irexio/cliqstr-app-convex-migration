  ...
  return (
    <header className="w-full bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 font-poppins">
        ...
        <Link
          href="/"
          className="text-2xl font-bold text-[#202020] lowercase"
        >
          cliqstr
        </Link>
        ...
        <nav className="flex flex-wrap items-center gap-6 text-sm font-medium text-[#202020]">
          ...
          <Link href="/explore" className="hover:text-[#d176e1] transition">
            Explore Public Cliqs
          </Link>
          <Link href="/how-it-works" className="hover:text-[#d176e1] transition">
            How It Works
          </Link>
          <Link href="/about" className="hover:text-[#d176e1] transition">
            About
          </Link>
          <Link href="/faq" className="hover:text-[#d176e1] transition">
            FAQs
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-4 text-sm">
          {!isLoggedIn ? (
            <>
              <Link
                href="/sign-in"
                className="text-[#202020] hover:text-[#d176e1] transition"
              >
                Sign In
              </Link>
              <Link
                href="/sign-up"
                className="bg-[#6f4eff] text-white px-4 py-2 rounded-md font-semibold hover:bg-[#5939d4] transition"
              >
                Sign Up
              </Link>
            </>
