// 🔐 APA-HARDENED — Create cliq in DB with real session and optional cover image
...
const schema = z.object({
  ...
  privacy: z.enum(['private', 'public', 'semi']),
  coverImage: z.string().url().optional(), // ✅ new field for banner image
});
  ...
  try {
    ...
    const newCliq = await prisma.cliq.create({
      data: {
        ...
        privacy,
        coverImage: coverImage || null, // ✅ save it if present
