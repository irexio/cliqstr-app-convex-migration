...
*This file is automatically generated. Last updated: 2025-07-20T15:52:54.984Z*
...
| `/invite/accept` | None | 🔐 APA-HARDENED — Invite Acceptance Page This page handles invite acceptance redirects. It receives an invite code via URL query parameter and redirects to the invite page. Security notes: - No direct account creation happens here - This is just a redirect to the main invite page where proper verification happens - Invite codes are validated server-side |
...
```
10acb30 - Fix email subject line: use username instead of user ID for inviter name (13 hours ago)
708a072 - Fix infinite loading on invite accept page - add timeout and comprehensive error handling (13 hours ago)
064c78d - Force fresh deployment to clear API route caching (14 hours ago)
3c80483 - Fix invite creation API to properly select database fields (14 hours ago)
cec1a28 - Fix invite validation API to select required database fields (18 hours ago)
3883c50 - Clean up console.log statements in my-cliqs-dashboard (21 hours ago)
82c90bc - Fix LoadingSpinner import paths in invite pages (21 hours ago)
6f554b3 - Fix 'use client' directive placement - must be first line in file (22 hours ago)
7a56274 - Fix build errors: Add dynamic exports, fix useSession destructuring, wrap useSearchParams in Suspense (22 hours ago)
22dc916 - Fix deployment errors: Remove conflicting route file and fix auth imports (22 hours ago)
```
