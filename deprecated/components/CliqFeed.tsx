...
/**
 * 🚨 DEPRECATED: This component has been rewritten with Convex optimizations
 * 
 * Use: CliqFeedConvex.tsx instead
 * 
 * The new version:
 * - Uses real-time Convex queries instead of API calls
 * - More efficient and enables live updates
 * - Better performance and user experience
 * 
 * @deprecated Use CliqFeedConvex.tsx instead
 */
